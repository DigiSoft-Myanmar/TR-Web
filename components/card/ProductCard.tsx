...
function ProductCard({ product }: { product: any }) {
  ...
  return (
    <Link
      className="max-w-[200px] min-w-[200px] overflow-hidden flex flex-col gap-3 rounded-md cursor-pointer bg-white relative border hover:border-primary transition"
