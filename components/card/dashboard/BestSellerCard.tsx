      ...
      <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col bg-white p-5 flex-1 gap-1 items-center lg:items-start shadow hover:border-primary border border-gray-50 rounded-sm cursor-pointer">
            ...
            <p className="font-bold text-lg">
              ...
              <span className="text-xs font-light">
                ...
                {formatAmount(
                  data.bestBuyerByUnit.totalProfit,
                  "en",
                  true,
                  true
                )}{" "}
        ...
        {data.bestBuyerByProfit && (
          <div className="flex flex-col bg-white p-5 flex-1 gap-1 items-center lg:items-start shadow hover:border-primary border border-gray-50 rounded-sm cursor-pointer">
            ...
            <p className="font-bold text-lg">
              {formatAmount(
                data.bestBuyerByProfit.totalProfit,
                "en",
                true,
                true
              )}{" "}
      ...
      <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col bg-white p-5 pb-0 flex-1 gap-1 items-center lg:items-start shadow hover:border-primary border border-gray-50 rounded-sm cursor-pointer">
            ...
            <p className="font-bold text-lg">
              ...
              <span className="text-xs font-light">
                units sold with{" "}
                {formatAmount(
                  data.bestProdByUnit.totalProfit,
                  "en",
                  true,
                  true
                )}{" "}
        ...
        {data.bestProdByProfit && (
          <div className="flex flex-col bg-white p-5 pb-0 flex-1 gap-1 items-center lg:items-start shadow hover:border-primary border border-gray-50 rounded-sm cursor-pointer">
            ...
            <p className="font-bold text-lg">
              {formatAmount(
                data.bestProdByProfit.totalProfit,
                "en",
                true,
                true
              )}{" "}
          ...
          <div className="flex flex-col bg-white p-5 pb-0 flex-1 gap-1 items-center lg:items-start shadow hover:border-primary border border-gray-50 rounded-sm cursor-pointer">
            ...
            <p className="font-bold text-lg">
              ...
              <span className="text-xs font-light">
                won with{" "}
                {formatAmount(
                  data.bestAuctionByAmount.units,
                  "en",
                  false,
                  true
                )}{" "}
