...
function ProductImg({
  ...
  const imgEle = React.useRef<HTMLImageElement | null>(null);
  ...
  return (
    <>
      <div
        className={`group relative z-10 shadow-md ${
          roundedAll ? "rounded-md" : "rounded-t-md"
        }`}
        style={
          bgColor && width
            ? {
      ...
      >
        ...
        />
        {loading === true && (
          <div className="absolute top-1/2 left-10 right-10">
        ...
        {error === true && (
          ...
          >
            <g>
              ...
              />
              <path
                d="M385.16196,67.18643l-27,12,17.23959,89.01208-2.72385,127.75565-18,38s-3.01575,21.73227,27.98425,7.73227,66-18,66-18l-8.5-58.5-7.5-153.5,1-34-22-14-26.5,3.50001Z"
                fill="#2f2e41"
              />
              <path
              ...
              />
              <g>
                <circle cx="333.2486" cy="323.64455" r="85" fill="#e71d2a" />
                <g>
                  <path
              ...
              <path
                id="uuid-9e184911-a7a6-47a4-9ff9-47390ebd3646-149"
              ...
              <g>
                <path
                  id="uuid-45fc0dc4-7ddb-4673-9103-f7b0be414001-150"
