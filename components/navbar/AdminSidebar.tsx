        ...
        <nav aria-label="Main Nav" className="mt-6 flex flex-col pl-1">
          ...
          {session &&
            (session.role === Role.Admin ||
              ...
              >
                ...
                >
                  {hasPermission(session, BuyerPermission.buyerViewAllow) && (
                    <Tooltip title="Buyers" placement="right">
                      <Link
                  ...
                  {hasPermission(session, SellerPermission.sellerViewAllow) && (
                  ...
                  {hasPermission(session, TraderPermission.traderViewAllow) && (
                  ...
                  {hasPermission(session, StaffPermission.staffViewAllow) && (
          ...
          >
                ...
                <>
                  ...
                  <Tooltip title="Auction Products" placement="right">
                    <Link
                      ...
                      className={
                        router.asPath ===
                        "/products?type=" + ProductType.Auction
                          ? "active-route flex items-center bg-gray-100 px-4 py-2 text-gray-700"
                          : "flex items-center px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700"
                      }
                    >
			...
			c-1.162,1.999-1.389,4.407-0.619,6.589c0.768,2.18,2.457,3.913,4.617,4.739l21.175,8.104L203.456,392.026z"
              ...
              {hasPermission(session, otherPermission.categoriesView) && (
              ...
              {hasPermission(session, otherPermission.attributeView) && (
              ...
              {hasPermission(
                session,
                ConditionPermission.conditionViewAllow
              ) && (
          ...
          {hasPermission(session, OrderPermission.orderViewAllow) && (
          ...
          {hasPermission(session, AuctionPermission.endedAuctionView) && (
          ...
          {hasPermission(session, AuctionPermission.allBidAuctionView) && (
          ...
          {hasPermission(session, otherPermission.adsView) && (
          ...
          {hasPermission(session, otherPermission.promotionView) && (
          ...
          (session.role === Role.Admin ||
            (session.role === Role.Staff &&
              (hasPermission(session, otherPermission.reviewView) ||
                hasPermission(session, otherPermission.helpCenterMessageView) ||
                hasPermission(session, otherPermission.feedbacksView))) ||
            session.role === Role.SuperAdmin) ? (
            <details
              className="group"
