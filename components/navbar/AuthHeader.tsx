          ...
          <div className="relative flex items-center sm:justify-between sm:gap-4">
            ...
            <div className="flex flex-1 items-center justify-between gap-8 sm:justify-end">
              <div className="flex gap-4">
                <button
                  type="button"
                  className="indicator relative block shrink-0 rounded-lg bg-white p-2.5 text-gray-600 shadow-sm hover:text-white hover:bg-primary transition"
                  onClick={() => {
                    turnOffNotiPing();
                ...
                >
                  {isNotiPing > 0 && (
                    <span className="indicator-item badge badge-accent px-1">
                ...
                <button
                  className="relative block shrink-0 rounded-lg bg-white p-2.5 text-gray-600 shadow-sm hover:text-white hover:bg-primary transition"
                  onClick={() => {
