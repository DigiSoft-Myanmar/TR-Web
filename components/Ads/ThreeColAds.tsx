...
function ThreeColAds({ adsList1, adsList2, adsList3, adsLocations }: Props) {
  ...
  return (
    <section className="text-white rounded-md mx-10 md:mx-20 my-10 grid grid-cols-1 md:grid-cols-3 gap-5 place-items-center">
      {adsList1.length > 0 ? (
        <div
      ...
      {adsList3.length > 0 ? (
        <div
          className={`px-4 py-10 mx-auto lg:items-center lg:flex overflow-hidden min-w-[250px] h-[250px]`}
        >
