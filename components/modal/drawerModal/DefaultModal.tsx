...
function DefaultModal({ isModalOpen, setModalOpen }: Props) {
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <div className="absolute left-0 top-0 bottom-0 flex max-w-md transform overflow-auto rounded-r-xl bg-primary shadow-xl transition-all">
