...
function SingleGalleryModal({
  ...
  const limit = 15;
  const [seller, setSeller] = React.useState(sellerId);
                          ...
                          <div className="flex flex-wrap justify-start gap-3 px-4 py-2">
                            {data.docs.map((elem: any, index: number) => (
                              <SelectImage
                                ...
                                isChecked={file === `${elem.filename}`}
                                setChecked={() => setFile(`${elem.filename}`)}
                              />
                            ))}
                          </div>
                        </>
...
export default SingleGalleryModal;
