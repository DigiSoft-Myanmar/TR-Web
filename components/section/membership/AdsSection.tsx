  ...
  return (
    <div className="flex flex-col">
      ...
      <form className="flex flex-col space-y-3" onSubmit={handleSubmit(submit)}>
        ...
        <FormInput
          label={t("adsValidity")}
          placeHolder={t("enter") + " " + t("adsValidity")}
          error={errors.adsValidity?.message}
          type="number"
        ...
        <FormInput
          label={t("adsLifeTime")}
          placeHolder={t("enter") + " " + t("adsLifeTime")}
          error={errors.adsLifeTime?.message}
          type="number"
        ...
        <FormInput
          label={t("extraAdsPricing")}
          placeHolder={t("enter") + " " + t("extraAdsPricing")}
          error={errors.extraAdsPricing?.message}
          type="number"
        ...
        <FormInputRichText
          content={membership?.adsDetails}
          label={t("adsDetails") + " " + t("eng")}
          setContent={(e: string) => {
            setMembership((prevValue: any) => {
              return { ...prevValue, adsDetails: e };
            });
          }}
        />

        {membership?.adsDetails && membership?.adsDetails.length > 0 ? (
          <FormInputRichText
            content={membership?.adsDetailsMM}
            label={t("adsDetails") + " " + t("mm")}
            setContent={(e: string) => {
              setMembership((prevValue: any) => {
                return { ...prevValue, adsDetailsMM: e };
              });
            }}
          />
        ) : (
